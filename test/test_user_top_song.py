...
def test_count_frequency_should_count_songs_played_by_user(user_top_song, input_file):
...
def test_filter_should_filter_songs_as_specified_in_number(user_top_song):
